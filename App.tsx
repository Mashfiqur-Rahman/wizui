...
import Tabs from './src/components/NavigationComponents/Tabs/Tabs';
...
export default function App() {
    ...
    const tabs = [
        ...
        {
            label: 'Profile',
            content: <View><Text>This is the Profile tab content</Text></View>,
        },
        {
            label: 'Settings',
            content: <View><Text>This is the Settings tab content</Text></View>,
        },
    ];
    return (
